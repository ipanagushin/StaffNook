    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeWorkingTimes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeeWorkingTimes_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeWorkingTimes_Projects_ProjectId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("a3ee775e-6333-4366-9ab4-28ba5b20a2ba"), null, "Administrator", "ADMINISTRATOR" },
                    { new Guid("cb027da7-62e3-4678-859b-ffdb92664c78"), null, "User", "USER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeWorkingTimes_EmployeeId",
                table: "EmployeeWorkingTimes",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeWorkingTimes_Id_EmployeeId",
                table: "EmployeeWorkingTimes",
                columns: new[] { "Id", "EmployeeId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeWorkingTimes_ProjectId",
                table: "EmployeeWorkingTimes",
                column: "ProjectId");
